...
export default function BuySilverFlowPage() {
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="text-center">
        <h1 className="text-4xl font-black text-white tracking-tight mb-2">Buy Silver</h1>
        <p className="text-white/40 text-sm font-medium">Choose your preferred investment method</p>
      </header>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
        <Link to="/silver" className="card-premium group hover:border-gray-400/50 transition-all p-8 flex flex-col items-center gap-6 text-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-gray-400/5 rounded-full blur-3xl -mr-32 -mt-32 pointer-events-none group-hover:bg-gray-400/10 transition-colors"></div>
          <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-gray-400/20 to-transparent flex items-center justify-center text-gray-300 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(156,163,175,0.3)] transition-all duration-500">
          ...
          <div className="mt-auto flex items-center gap-2 text-gray-300 font-bold text-sm uppercase tracking-widest group-hover:gap-4 transition-all">
            Continue <ArrowRight size={16} />
          </div>
        </Link>

        <Link to="/silver/sip" className="card-premium group hover:border-green-500/50 transition-all p-8 flex flex-col items-center gap-6 text-center relative overflow-hidden">
